...
<p align="left">
  ...
  <a href="https://redux-toolkit.js.org/" target="_blank" rel="noopener noreferrer" title="Redux Toolkit">
    <img src="https://skillicons.dev/icons?i=redux" width="40" height="40" alt="Redux Toolkit"/>
  </a>
...
<p align="left">
  ...
  <a href="https://expressjs.com/" target="_blank" rel="noopener noreferrer" title="Express.js">
...
### 🐾 [**Petlove**](https://petlove-ten.vercel.app/)
Platform for browsing, searching, and posting pet adoption listings.  
**Tech:** React, TypeScript, Redux Toolkit, REST API, React Router, Vite  
🔗 [GitHub Repo](https://github.com/vmgurnak/Petlove)

---

### 🎬 [**Movies**](https://movies-azure-one.vercel.app/)
Multilingual movie search platform with favorites, pagination, and trailers.  
**Tech:** React, Redux Toolkit, TypeScript, i18next, REST API  
🔗 [GitHub Repo](https://github.com/vmgurnak/CinemaSearch)

---

### 🚐 [**TravelTracks**](https://travel-trucks-nu-three.vercel.app/)
Camper rental app with catalog, filtering, and booking functionality.  
**Tech:** React, Redux Toolkit, TypeScript, REST API, Vite  
🔗 [GitHub Repo](https://github.com/vmgurnak/TravelTrucks)

---

### 💼 [**WebStudio**](https://vmgurnak.github.io/WebStudio/)
Responsive landing page for a digital agency.  
**Tech:** HTML5, CSS3, JavaScript  
🔗 [GitHub Repo](https://github.com/vmgurnak/WebStudio)

---

### 🏋️ [**Kropp CrossFit**](https://vmgurnak.github.io/kropp-crossfit/)
...
⭐ *If you like my projects, feel free to follow or connect!*
